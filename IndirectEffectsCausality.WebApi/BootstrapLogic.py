...
class BootstrapLogic():  
   ...
   def compute_nnt_effects(self, data, exposure, mediator, outcome, confounders, mediator_model, target_model, B=1, selected_effects=None):
